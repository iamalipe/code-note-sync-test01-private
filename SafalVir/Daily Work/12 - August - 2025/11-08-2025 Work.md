...
Filters for all of the tabs. (IOS and WEB)


1. Incident to drainage Link and incident to Doctor and Nurse Link API + UI
2. Drainage Taking Time Configuration and Reminder API + UI - DONE
3. Notification Trigger (Low, Mid, High Priority) Configuration API + UI - DONE
4. Incident Report Generation API + UI
5. Incident Level **drainage** Field Configuration API + UI
6. Drainage Record comment and Notifications API + UI
7. Admin Level Master Switch for Drainage and Incident API + UI
    1. UI - DONE
