...
Drainage Monitoring & Incident Management:  
1. Active Drainage Incidents – Track active incidents in real time. API + UI - DONE
2. Patient Count/Amount by Drainage Type – View patient data with filters (Day, Week, Month). API + UI - DONE
3. Missed Drainage's List by Patients – Identify patients who missed drainage. API + UI - DONE
4. High Priority Dashboard Notifications – Display urgent alerts directly on the dashboard. API + UI - DONE

Configuration & Automation:  
1. Drainage Type Configuration by admin – Define Amount thresholds (Min, Avg, Max). API - DONE
2. Drainage Type & Location Priority Setup – Assign priority levels based on type and location. - API - DONE
...
1. Total Patient Count, There incident Count, Drainage Count/Amount/Avg
2. Active Incident and there Total Drainage Count, Total Drainage Amount in a table format.
3. Show Top 3 High Alert then Count of High, Mid, Low
4. Bar Chart Horizontal for Drainage Amount by Patient (open show top 5) can be filter by Drainage type
5. Area/Line Chart for Weekly Drainage Count/Amount, can be filter  by duration and Drainage type
