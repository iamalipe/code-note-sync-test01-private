...
1. Remove Doctor notified from the Create drainage record model. (IOS and WEB) - DONE
2. Place holder for the Temperature field should be 98. (IOS and WEB) - Discuss later
3. Patient in Doc / Nurse view should have these details: (IOS and WEB)
	1. Name and DOB
	2. ID and Email

4. Remove Doctor notified from the Create drainage record model. (IOS and WEB) - DONE
5. Show colors and Icons for the fields displayed on Drainage Record list view. (IOS and WEB) - DONE
6. Basic Incident Create and update API + UI - DONE
7. Filters for all of the tabs. (IOS and WEB)
8. Basic Incident Create and update API + UI
9. Incident to drainage Link and incident to Doctor and Nurse Link API + UI
10. Drainage Taking Time Configuration and Reminder API + UI
11. Notification Trigger (Low, Mid, High Priority) Configuration API + UI
12. Incident Report Generation API + UI
13. Incident Level **drainage** Field Configuration API + UI
14. Drainage Record comment and Notifications API + UI
15. Admin Level Master Switch for Drainage and Incident API + UI
    1. UI - DONE
