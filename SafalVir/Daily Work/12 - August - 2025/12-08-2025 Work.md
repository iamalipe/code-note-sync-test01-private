...
1. Incident to drainage Link and incident to Doctor and Nurse Link API + UI - DONE
2. Incident Level drainage Field Configuration API + UI - DONE
3. Upcoming drainage API + UI - DONE


4. Incident Report Generation API + UI
5. Drainage Record comment and Notifications API + UI
6. Admin Level Master Switch for Drainage and Incident API + UI
    1. UI - DONE
