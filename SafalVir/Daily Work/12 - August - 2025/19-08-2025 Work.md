1. Show Count for Linked Incident in Table - DONE
2. Show Linked incident together in Table as a Parent and child format - In Progress
3. Take Hemant Vishwakarma KT for SafalUtil
4. Consider Doctor current time zone in pdf report
