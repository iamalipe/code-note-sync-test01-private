...
21/08/2025
1. Change Log API + UI - DONE
2. Filter, Search added in changelog - DONE
3. PDF small style changes - DONE

Bugs
5. Cron Job bugs => Patient Don't getting Reminder Notification - DONE
6. SIRM-WEB-0021: Create incident - "Catheter Insertion Date" - DONE
7. Timezone added in dashboard api - DONE
8. SIRM-WEB-0022: End date not working - DONE


Active Count Incident, Drainage.
Active Count/Amount patient based on the Drainage Type (Filter - Day, Week, Month).
Show High Priority Notification on Dashboard
Miss Drainage List Patient
Config of Drainage Type - Amount - Min, Avg, Max
Config of Drainage Type with Location - Priority
	
Auto Tag Patient And Incident based on Drainage Type Config
Login Alart Notification + Change Logs
Login 2FA via SMS, EMAIL, PassKey
