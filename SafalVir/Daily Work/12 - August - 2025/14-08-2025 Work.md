...
1. Drainage Record comment and Notifications API + UI - DONE
2. Dashboard API changes for IOS - DONE
3. Default Incident Notification and Schedule Added - DONE
4. Admin Level Master Switch for Drainage and Incident API - DONE
5. Incident closed and linked to Previous Incident - In Progress

6. Incident Report Generation API + UI
