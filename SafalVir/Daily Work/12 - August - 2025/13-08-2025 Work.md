...
1. Account Level Notification API + UI - DONE
2. Notification Trigger based on Doctor/Nurse Provided condition - DONE
3. Small API changes - DONE
4. Drainage Record comment and Notifications API + UI - In Progress

5. Incident Report Generation API + UI
